...
function changeName(uint _zombieId, string calldata _newName) external aboveLevel(2, _zombieId) { // calldata similar to memory but only for external functions 
